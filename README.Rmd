...
```{r example, eval = requireNamespace('paperdrugs')}
library("paperdrugs")
## basic example code
```
...
Below is the citation output from using `citation('paperdrugs')` in R. Please
run this yourself to check for any updates on how to cite __paperdrugs__.

```{r 'citation', eval = requireNamespace('paperdrugs')}
